...
var _ = Describe("Subtracting a tuple from another tuple", func() {
	It("Subtracting a tuple from another tuple should create a new tuple", func() {
		a := tuple.NewTuple(1.0, 2.0, 3.0, 1.0)
		b := tuple.NewTuple(4.0, 5.0, 6.0, 0)
		c := a.Sub(b)
...
var _ = Describe("Multiply a Tuple by a scalar", func() {
	It("Tuple multiplies a scalar should create a new tuple with components that are multiplied by the scalar", func() {
		var s = 2.0
